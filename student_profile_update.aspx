            ...
            <div class="row mt-2">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-8 mb-2">
                            <asp:TextBox required onkeypress="return TEXT" ID="TextBox14" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-sm-4 mb-2">
                            Gender
                        </div>
                        <div class="col-sm-8 mb-2">
                            <asp:DropDownList ID="DropDownList1" CssClass="form-select" runat="server">
                                <asp:ListItem>Choose gander</asp:ListItem>
                ...
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-8 mb-2">
                            <asp:TextBox required onkeypress="return text" ID="TextBox11" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-sm-4 mb-2">
                            Year of joining
                        </div>
                        ...
                        <div class="col-sm-8 mb-2">
                            <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/CV.aspx">Click here to create Resume</asp:LinkButton>
