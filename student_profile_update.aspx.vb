...
Partial Class student_profile_update
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        s = "update student set sname='" & TextBox1.Text & "',gender='" & DropDownList1.Text & "',dob='" & TextBox2.Text & "',cno='" & TextBox3.Text & "',email='" & TextBox4.Text & "',sslc='" & TextBox5.Text & "',y1='" & TextBox6.Text & "',p2='" & TextBox7.Text & "',y2='" & TextBox8.Text & "',ug='" & TextBox9.Text & "',y3='" & TextBox10.Text & "',pg='" & TextBox11.Text & "',y4='" & TextBox12.Text & "',skill='" & TextBox13.Text & "',img='" & img & "' where id=" & Session("id")
